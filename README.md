...
- 안녕하세요, 프론트엔드 개발자 **박수현**입니다.
- React, Vue, Redux 등 다양한 프론트엔드 기술을 활용하여 사용자 중심의 UI/UX를 구현합니다.
- 새로운 기술과 언어를 배우는 데 거부감이 없으며, 탐구하는 것을 즐깁니다.
- 유연한 사고와 깊이 있는 기술 이해를 통해 동료들과 함께 성장하는 개발자가 되고자 합니다.
